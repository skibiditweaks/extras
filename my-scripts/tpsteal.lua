--[[
tp scam script
by pospyro on discord
pop it script Note:
• Adjust your Roblox avatar's height and width to the maximum possible
• in the game buy: "Potion Invisible" and "Cold Plunge"
• Activate script, please do not touch the screen
• bring player Please click player
]]--

game.StarterGui:SetCore("SendNotification", {
Title = "Script Executed 📋",
Text = "Script should work. Credits to pospyro",
Duration = 5,
})
